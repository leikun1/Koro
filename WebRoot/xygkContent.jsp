...
<html>
  <head>
    ...
    <title>My JSP 'xygkContent.jsp' starting page</title>
            	...
            	<div class="dlTop">
                    ...
                    <div class="dlBotttom" >
                    	<div style=" padding-top:4px; font-size:12pt;font-family:'微软雅黑';">
                        	<a href="NewsViewServlet?ncname=学院简介" style="text-decoration:none;color:#000000;">学院简介</a>
                        </div>
                        <div style=" padding-top:16px;font-size:12pt;font-family:'微软雅黑';">
                        	<a href="#" style="text-decoration:none;color:#000000;">学院领导</a>
                        </div>
                        <div style=" padding-top:16px;font-size:12pt;font-family:'微软雅黑';">
                        	<a href="#" style="text-decoration:none;color:#000000;">组织机构</a>
                        </div>
                        <div style=" padding-top:16px;font-size:12pt;font-family:'微软雅黑';">
                        	<a href="XYGKServlet?ncname=学院新闻" style="text-decoration:none;color:#000000;">学院新闻</a>
                        </div>
                        <div style=" padding-top:16px;font-size:12pt;font-family:'微软雅黑';">
                        	<a href="XYGKServlet?ncname=通知公告" style="text-decoration:none;color:#000000;">通知公告</a>
                        </div>
                    </div>
                </div>
                <div class="dlMid">
            ...
            <div class="dRight">
            	<div class="drTop">
                	<div ><img src="images/tip_02.jpg" style="margin-left:-400px;" align='absmiddle'>
                        ...
                        <a href="XYGKServlet" style="text-decoration:none;font-size:12pt; color:#000000;">学院概况</a>》
                        <a href="XYGKServlet" style="text-decoration:none;font-size:12pt; color:#000000;">通知公告</a>
                    </div>
                    <div><img src="images/xugk.jpg"></div>
                </div>
                <div class="drMid">
