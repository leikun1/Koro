...
<body>
	...
	<form name="example" method="post" action="UpdateNewsServlet">
	标题:<input type="text" name="title" value="${nvo.ntitle}"/>
		<textarea name="content1" cols="100" rows="8" style="width:770px;height:400px;visibility:hidden;"><pre>${nvo.ncontent}</pre></textarea>
		<br />
		<input type="hidden" name="id" value="${nvo.nid}">
		<input type="submit" name="button" value="提交内容" /> (提交快捷键: Ctrl + Enter)<a href="ManagerServlet">管理内容</a>&nbsp;&nbsp;
		<a href="ManagerTec">管理师资队伍</a>&nbsp;&nbsp;
	</form>
