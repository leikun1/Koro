...
<html>
  <head>
    ...
    <title>My JSP 'szdw.jsp' starting page</title>
            	...
            	<div class="dlTop">
                    ...
                    <div class="dlBotttom" >
                    	<div style=" padding-top:4px; font-size:12pt;font-family:'微软雅黑';">
                        	<a href="NewsViewServlet?ncname=师资队伍" style="text-decoration:none;color:#000000;">师资队伍概况</a>
                        </div>
                        <div style=" padding-top:16px;font-size:12pt;font-family:'微软雅黑';">
                        	<a href="SZDWServlet?major=1" style="text-decoration:none;color:#000000;">计算机系</a>
                        </div>
                        <div style=" padding-top:16px;font-size:12pt;font-family:'微软雅黑';">
                        	<a href="SZDWServlet?major=2" style="text-decoration:none;color:#000000;">数学系</a>
                        </div>
                    </div>
                </div>
                <div class="dlMid">
            ...
            <div class="dRight">
            	<div class="drTop">
                	<div ><img src="images/tip_02.jpg" style="margin-left:-400px;" align='absmiddle'>
                        ...
                        <a href="" style="text-decoration:none;font-size:12pt; color:#000000;">师资队伍</a>》
                        <a href="" style="text-decoration:none;font-size:12pt; color:#000000;">${ncname}</a>
                    </div>
                    <div><img src="images/szdw.jpg"></div>
                </div>
                <div class="drMid">
                	...
                	<div>
                		<c:forEach items="${lst}" var ="tvo">
                    		<div class="notice" >
                            	<a href="SZDWServlet?id=${tvo.tid}"><img src="images/tip_03.jpg">&nbsp;&nbsp;${tvo.tname}</a>
                            </div>
                         </c:forEach>                      
                    </div>
                </div>
                <div class="drBottom">
                    ...
                    <a href="SZDWServlet?pageIndex=${pageIndex-1}&major=${tmajor}"><img src="images/sy.jpg"></a>&nbsp;
                    </c:if>
                    <c:if test="${pageIndex<totalPage}">
                    <a href="SZDWServlet?pageIndex=${pageIndex+1}&major=${tmajor}"><img src="images/xy.jpg"></a>&nbsp;
                    </c:if>
                    <a href="SZDWServlet?pageIndex=${totalPage}&major=${tmajor}"><img src="images/wy.jpg"></a>&nbsp;
                </div>
            </div>
        </div>
