...
<html>
  <head>
    ...
    <title>My JSP 'zsjyContent.jsp' starting page</title>
            	...
            	<div class="dlTop">
                    ...
                    <div class="dlBotttom" >
                    	<div style=" padding-top:4px; font-size:12pt;font-family:'微软雅黑';">
                        	<a href="XYGKServlet?ncname=本科生招生" style="text-decoration:none;color:#000000;">本科生招生</a>
                        </div>
                        <div style=" padding-top:16px;font-size:12pt;font-family:'微软雅黑';">
                        	<a href="XYGKServlet?ncname=研究生招生" style="text-decoration:none;color:#000000;">研究生招生</a>
                        </div>
                        <div style=" padding-top:16px;font-size:12pt;font-family:'微软雅黑';">
                        	<a href="XYGKServlet?ncname=就业信息" style="text-decoration:none;color:#000000;">就业信息</a>
                        </div>
                    </div>
                </div>
                <div class="dlMid">
            ...
            <div class="dRight">
            	<div class="drTop">
                	<div ><img src="images/tip_02.jpg" style="margin-left:-400px;" align='absmiddle'>
                        ...
                        <a href="XYGKServlet" style="text-decoration:none;font-size:12pt; color:#000000;">招生就业</a>》
                        <a href="XYGKServlet" style="text-decoration:none;font-size:12pt; color:#000000;">${ncname}</a>
                    </div>
                    <div><img src="images/zsjy.jpg"></div>
                </div>
                <div class="drMid">
