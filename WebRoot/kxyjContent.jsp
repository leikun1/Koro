...
<html>
  <head>
    ...
    <title>My JSP 'kxyjContent.jsp' starting page</title>
            	...
            	<div class="dlTop">
                    ...
                    <div class="dlBotttom" >
                    	<div style=" padding-top:4px; font-size:12pt;font-family:'微软雅黑';">
                        	<a href="XYGKServlet?ncname=科研项目" style="text-decoration:none;color:#000000;">科研项目</a>
                        </div>
                        <div style=" padding-top:16px;font-size:12pt;font-family:'微软雅黑';">
                        	<a href="XYGKServlet?ncname=学术论文" style="text-decoration:none;color:#000000;">学术论文</a>
                        </div>
                        <div style=" padding-top:16px;font-size:12pt;font-family:'微软雅黑';">
                        	<a href="XYGKServlet?ncname=基地建设" style="text-decoration:none;color:#000000;">基地建设</a>
                        </div>
                    </div>
                </div>
                <div class="dlMid">
            ...
            <div class="dRight">
            	<div class="drTop">
                	<div ><img src="images/tip_02.jpg" style="margin-left:-400px;" align='absmiddle'>
                        ...
                        <a href="XYGKServlet" style="text-decoration:none;font-size:12pt; color:#000000;">科学研究</a>》
                        <a href="XYGKServlet" style="text-decoration:none;font-size:12pt; color:#000000;">${ncname}</a>
                    </div>
                    <div><img src="images/kxyj.jpg"></div>
                </div>
                <div class="drMid">
