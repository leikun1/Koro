...
<html>
  <head>
    ...
    <title>My JSP 'djgzContent.jsp' starting page</title>
            	...
            	<div class="dlTop">
                    ...
                    <div class="dlBotttom" >
                    	<div style=" padding-top:4px; font-size:12pt;font-family:'微软雅黑';">
                        	<a href="XYGKServlet?ncname=组织架构" style="text-decoration:none;color:#000000;">组织架构</a>
                        </div>
                        <div style=" padding-top:16px;font-size:12pt;font-family:'微软雅黑';">
                        	<a href="XYGKServlet?ncname=党员风采" style="text-decoration:none;color:#000000;">党员风采</a>
                        </div>
                        <div style=" padding-top:16px;font-size:12pt;font-family:'微软雅黑';">
                        	<a href="XYGKServlet?ncname=党组织活动" style="text-decoration:none;color:#000000;">党组织活动</a>
                        </div>
                    </div>
                </div>
                <div class="dlMid">
            ...
            <div class="dRight">
            	<div class="drTop">
                	<div ><img src="images/tip_02.jpg" style="margin-left:-400px;" align='absmiddle'>
                        ...
                        <a href="XYGKServlet" style="text-decoration:none;font-size:12pt; color:#000000;">党建工作</a>》
                        <a href="XYGKServlet" style="text-decoration:none;font-size:12pt; color:#000000;">${ncname}</a>
                    </div>
                    <div><img src="images/djgz.jpg"></div>
                </div>
                <div class="drMid">
