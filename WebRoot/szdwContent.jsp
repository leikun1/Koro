...
<html>
  <head>
    ...
    <title>My JSP 'szdwContent.jsp' starting page</title>
            ...
            <div class="dRight">
            	<div class="drTop">
                	<div ><img src="images/tip_02.jpg" style="margin-left:-400px;" align='absmiddle'>
                        ...
                        <a href="XYGKServlet" style="text-decoration:none;font-size:12pt; color:#000000;">师资队伍</a>》
                        <a href="XYGKServlet" style="text-decoration:none;font-size:12pt; color:#000000;">${ncname}</a>
                    </div>
                ...
                <div class="drMid">
                	...
                	<strong>${nvvo.ntitle}${tvo.tname}</strong><br>
                	<p>发布时间：${nvvo.ntime}${tvo.tdate}</p>
                	 ${nvvo.ncontent}${tvo.tprief}
